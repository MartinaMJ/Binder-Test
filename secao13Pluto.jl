...
# ╔═╡ 39ab2159-9f73-477e-8086-2299e55170fc
using Plots, PlutoUI

# ╔═╡ f4c4a330-a259-11ed-04bc-a1ab9f48e7c9
md"""# Bases and Dimension
...
# ╔═╡ 608f50aa-4ca5-42d0-9dfa-66335ac193eb
md"""Base $\begin{bmatrix}
			1\\
			0
\end{bmatrix}$ , 
$\begin{bmatrix}
...
# ╔═╡ 230072e9-1634-48a3-8f6e-7194af144b48
begin
	vertical = @bind vetorVertical html"<input type=range>"
	horizontal = @bind vetorHorizontal html"<input type=range>"
...
# ╔═╡ 96a5edcf-f533-48fc-9d86-53d4c8d51083
begin
	plt=plot()
	x = [vetorHorizontal, 0, vetorHorizontal]
	y = [0, vetorVertical, vetorVertical]
	scatter!(plt,x,y)
end

# ╔═╡ 0a9a2026-0a2b-4ec7-bb5c-b7c22da8b9f3
begin
	verticalText = @bind vetorVerticalT html"<input type=text>"
	horizontalText = @bind vetorHorizontalT html"<input type=text>"
...
# ╔═╡ eb3baf23-d615-4d2d-844d-a5342ac39a10
try
	verticalConvertido = parse(Float64, vetorVerticalT)
	horizontalConvertido = parse(Float64, vetorHorizontalT)
	begin
		plt1=plot()
		plot!(plt1,[0,horizontalConvertido],[0,verticalConvertido],arrow=true,color=:blue,linewidth=2,label="")
		plot!(plt1,[0,0],[0,verticalConvertido],arrow=true,color=:black,linewidth=2,label="")
		plot!(plt1,[0,horizontalConvertido],[0,0],arrow=true,color=:black,linewidth=2,label="")
	end
catch
	println("Insira um número real.")
end

# ╔═╡ d85c6f40-7203-41a3-a709-17878f7b938b
md"""Base $\begin{bmatrix}
			1\\
			2
\end{bmatrix}$ , 
...
# ╔═╡ 47647cf5-738f-4a78-ad39-1fda5c282b33
begin
	PrimeiroText = @bind primeirovetorT html"<input type=text>"
	SegundoText = @bind segundovetorT html"<input type=text>"
	
	md"""
	Escalar do primeiro vetor: $(PrimeiroText)
	
	Escalar do segundo vetor: $(SegundoText)
	"""
end

# ╔═╡ 24d63613-d960-4e36-9522-4d2350c1af3c
md""" {{primeirovetorT}}$\begin{bmatrix}
			1\\
			2
\end{bmatrix}$ + 
{{segundovetorT}}$\begin{bmatrix}
			4\\
			3
\end{bmatrix}$""" 

# ╔═╡ 8a157655-7cc9-4eb8-8d10-934c4e4f38b3
try
	primeiroConvertido = parse(Float64, primeirovetorT)
	segundoConvertido = parse(Float64, segundovetorT)
	begin
		plt2 = plot()
		
		plot!(plt2, [0,primeiroConvertido], [0, 2*primeiroConvertido], arrow=true, color=:black, linewidth=2, label="")
		
		plot!(plt2, [0, 4*segundoConvertido],[0, 3*segundoConvertido], arrow=true, color=:black,linewidth=2,label="")
		
		plot!(plt2, [0, primeiroConvertido + 4*segundoConvertido],[0, 2*primeiroConvertido + 3*segundoConvertido], arrow=true, color=:blue, linewidth=2, label="")
	end
catch
	println("Insira um número real.")
end
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "e6a0730dc47382962d1dd988c5cd76021222d4e2"
